...
- [ ] Delete test account, restore 9HLG5W95 used_count to 0
- [ ] Dedicated test invite code "ZZ TEST — do not issue"; never spend real codes
- [ ] isEmailNotConfirmed + shared message (no "below"); button sentence in auth.tsx
- [ ] Resend button on sign-in, follows field, 60s countdown
