        ...
        {GALLERY.map((g, i) => (
          ...
          >
            ...
            <div
              ...
              style={{
                background: `linear-gradient(${(i * 37) % 360}deg, oklch(0.62 0.24 25 / 0.4), oklch(0.18 0.006 260) 60%, oklch(0.1 0 0))`,
              }}
            />
            <div className="absolute inset-0 grid place-items-center opacity-40">
              <ImageIcon className="h-10 w-10 text-white/60" strokeWidth={1} />
            </div>
